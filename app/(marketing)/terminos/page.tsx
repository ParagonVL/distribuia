...
export const metadata: Metadata = {
  title: "Términos de Servicio - Distribuia",
  description: "Términos y condiciones de uso de Distribuia.",
};
...
export default function TérminosPage() {
  return (
    <div className="prose prose-gray max-w-none">
      ...
      <section className="mb-8">
        <h2 className="font-heading text-xl font-semibold text-navy mb-4">
          1. Aceptacion de los términos
        </h2>
        <p className="text-gray-600 mb-4">
          Al acceder y utilizar Distribuia (&quot;el Servicio&quot;), aceptas estos Términos de Servicio.
          Si no estás de acuerdo con alguna parte de estos términos, no podrás utilizar el Servicio.
        </p>
        <p className="text-gray-600">
          Estos términos constituyen un acuerdo legal vinculante entre tu y el prestador del
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-600 mb-4">
          ...
          artículos y textos en publicaciones para redes sociales.
        </p>
        <p className="text-gray-600 p-4 bg-amber-50 border border-amber-200 rounded-lg">
          <strong>Uso de inteligencia artificial:</strong> Distribuia utiliza tecnología de inteligencia
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-4">
          <li>Proporcionar una dirección de correo electronico valida</li>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-4">
          ...
          <li><strong>Licencia limitada:</strong> Nos concedes una licencia limitada para procesar tu contenido únicamente para proporcionarte el Servicio.</li>
          <li><strong>Verificación:</strong> Eres responsable de verificar que el contenido generado no infringe derechos de terceros antes de publicarlo.</li>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-600 mb-4">
          Distribuia ofrece diferentes planes de suscripción:
        </p>
        <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-4">
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-600 mb-4">
          ...
          dispones de 14días desde la contratacion de tu primera suscripción de pago para ejercer el derecho
        ...
        <p className="text-gray-600 mb-4">
          ...
          que transcurra el plazo de 14 días, al aceptar estos términos y marcar la casilla correspondiente durante
          el proceso de pago, renuncias expresamente al derecho de desistimiento conforme al artículo 103.m) del
          Real Decreto Legislativo 1/2007.
        </p>
        <p className="text-gray-600">
          <strong>Suscripciónes en curso:</strong> Para el segundo mes en adelante, no se realizan reembolsos
      ...
      <section className="mb-8">
        <h2 className="font-heading text-xl font-semibold text-navy mb-4">
          7. Renovación y cancelacion
        </h2>
        <p className="text-gray-600 mb-4">
          Las suscripciónes se renuevan automaticamente cada mes. Puedes cancelar en cualquier momento
          desde tu panel de configuración o el portal de Stripe.
        </p>
        <p className="text-gray-600 mb-4">
          Al cancelar, mantendrás acceso hasta el final del periodo facturado.
        </p>
        <p className="text-gray-600">
          Si bajas de plan, el cambio será efectivo en el siguiente ciclo de facturación.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-4">
          ...
          <li>Distribuir malware o código danino</li>
        ...
        <p className="text-gray-600">
          ...
          notificandote por email con 7días de antelacion salvo en casos de violaciones graves
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-600">
          ...
          tras los cambios implica la aceptacion de los nuevos términos.
        </p>
      </section>

      <section className="mb-8">
        <h2 className="font-heading text-xl font-semibold text-navy mb-4">
          12. Legislacion aplicable y resolución de disputas
        </h2>
        <p className="text-gray-600 mb-4">
          Estos términos se rigen por la legislacion espanola. Para cualquier controversia,
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-600 mt-4 p-4 bg-gray-50 rounded-lg border">
          Al utilizar Distribuia, confirmas que has leido, entendido y aceptado estos Términos de
          Servicio y nuestra{" "}
